 ...
 *   public JsonElement serialize(Id ids, Type typeOfId, JsonSerializationContext context) {
 *     return new JsonPrimitive(ids.getValue());
 *   }
 * }
 * </pre></p>
 * <p>
...
public interface JsonSerializer<T> {
     ...
     * {@code src} object itself since that will cause an infinite perform (Gson will call your
