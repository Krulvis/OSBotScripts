...
public class Duel {
    ...
    public void calculateMyOffer(boolean equalOffersAtHighOdds, int maxStakeValue) {
        ...
        myRoundedMultiplied = myRoundedMultiplied > maxStakeValue ? maxStakeValue : myRoundedMultiplied;
    }
