...
public class ATInteract extends ATMethodProvider {
    ...
    public boolean interact(final Rectangle rectangle) {
        return interact(new RectangleDestination(bot, rectangle));
    }

    public boolean interact(final Rectangle rectangle, final String action) {
        return interact(new RectangleDestination(bot, rectangle), action, null, false);
    }
