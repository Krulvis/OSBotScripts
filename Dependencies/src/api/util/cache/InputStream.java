...
public final class InputStream extends Stream {
	...
	private static final int[] BIT_MASK = new int[] { 0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095, 8191, 16383, 32767, 65535, 131071, 262143, 524287, 1048575, 2097151, 4194303, 8388607, 16777215, 33554431, 67108863, 134217727, 268435455,
	...
	public int readSmartA() {
		int var2 = this.buffer[this.offset] & 0xff;
		if (var2 < 128) {
			return this.readUnsignedByte() - 64;
		}
		return this.readUnsignedShort() - '\uc000';
	}
